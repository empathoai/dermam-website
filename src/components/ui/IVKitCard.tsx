...
export default function IVKitCard({ kit }: IVKitCardProps) {
 ...
 viewport={{ once: true }}
 className="bg-white rounded-[1rem] overflow-hidden border border-border-card shadow-sm hover:shadow-subtle hover:border-border-card-hover hover:-translate-y-1 transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] flex flex-col h-full group"
 >
 {/* Kit Image */}
