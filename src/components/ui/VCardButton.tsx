...
export default function VCardButton({ vcardUrl, qrImage, disabled }: VCardButtonProps) {
  ...
  return (
    <div className={`flex items-center gap-3 p-3 rounded-xl border transition-all duration-300 ${disabled ? 'opacity-50 grayscale cursor-not-allowed' : 'bg-white border-border-soft hover:border-sage-soft shadow-sm group-hover:shadow-md'}`}>
