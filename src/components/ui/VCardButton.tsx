...
export default function VCardButton({ vcardUrl, qrImage, disabled }: VCardButtonProps) {
  ...
  return (
    <div className={`flex items-center gap-3 p-3 rounded-[0.625rem] border transition-all duration-300 ${disabled ? 'opacity-50 grayscale cursor-not-allowed' : 'bg-white border-border-card hover:border-border-card-hover shadow-sm group-hover:shadow-subtle'}`}>
