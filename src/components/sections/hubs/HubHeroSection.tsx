  ...
  const renderHeadline = () => {
    ...
    return (
      <>
        ...
        <span className={`font-script normal-case font-light tracking-normal block w-full text-right text-[1.62em] md:text-[1.7em] leading-[0.78] mt-[-0.02em] pr-[0.5em] md:pr-[0.76em] ${content.accentClassName ?? ''}`}>
          {content.accentWord}
        </span>
        {after.trim() ? (
          <span className="block">
