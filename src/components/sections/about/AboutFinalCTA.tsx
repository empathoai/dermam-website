  ...
  return (
    <section className="relative isolate overflow-hidden py-32">
      ...
      <Container className="relative z-10">
        <div className="bg-base-900/85 backdrop-blur-md rounded-[1.5rem] px-8 py-20 md:p-20 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24 shadow-subtle border border-white/10 text-center lg:text-left">
