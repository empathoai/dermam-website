        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="order-2 lg:order-1">
             <div className="relative group">
                <div className="absolute -inset-4 bg-prf-soft/30 rounded-2xl -z-10 group-hover:scale-105 transition-transform duration-500" />
                <ResponsiveImage
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="bg-white rounded-2xl border border-border-soft overflow-hidden shadow-subtle">
                <div className="bg-prf text-white px-6 py-4">
                    <h3 className="text-sm font-semibold uppercase tracking-widest text-center">Evolución de la medicina regenerativa</h3>
                </div>
                <div className="divide-y divide-border-soft">
                    {education.comparison.map((item, idx) => (
                        <div key={idx} className="grid grid-cols-3 text-center">
                            <div className="p-4 bg-canvas/50 border-r border-border-soft text-[10px] font-bold uppercase text-text-secondary flex items-center justify-center">
                                {item.label}
                            </div>
