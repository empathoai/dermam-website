  ...
  return (
    <section className="py-32 relative overflow-hidden isolation-isolate">
      ...
      <Container className="relative z-10">
        <div className="bg-white/80 backdrop-blur-md rounded-[40px] px-8 py-20 md:p-20 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24 shadow-2xl border border-prf-soft">
          <div className="lg:max-w-xl text-center lg:text-left">
            ...
            <div className="flex flex-col gap-4 items-center lg:items-start text-xs text-text-secondary">
               <div className="flex items-center gap-2">
                    <MapPin size={14} className="text-prf" />
                    <span>{siteConfig.address}, {siteConfig.city}, {siteConfig.state}</span>
               </div>
               <div className="flex items-center gap-2">
                    <Phone size={14} className="text-prf" />
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto min-w-[280px]">
            <Button className="bg-prf hover:bg-prf-deep text-white py-4 shadow-xl shadow-prf/20">
              {finalCTA.primaryCTA}
            </Button>
            <Button variant="outline" className="py-4 border-prf text-prf hover:bg-prf hover:text-white">
