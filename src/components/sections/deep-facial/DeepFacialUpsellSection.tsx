...
export default function DeepFacialUpsellSection() {
  ...
  return (
    <section className="py-24 bg-canvas">
      <Container>
        <div className="max-w-6xl mx-auto rounded-[40px] bg-white border border-border-soft shadow-xl overflow-hidden flex flex-col lg:flex-row">
            <div className="lg:w-1/2 p-12 md:p-16 flex flex-col justify-center">
                <h2 className="text-3xl md:text-4xl mb-6 leading-tight">{upsell.headline}</h2>
