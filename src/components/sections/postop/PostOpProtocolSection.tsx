      ...
      <Container>
        ...
        <ResponsiveCardGroup desktopColumns={3} className="mb-16" mobileCardWidth="82vw">
          {protocol.phases.map((phase) => (
            <div key={phase.id} className="bg-white p-8 rounded-[1rem] border border-border-card relative group hover:-translate-y-1 hover:border-border-card-hover hover:shadow-subtle transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]">
