...
export default function PostOpRelatedTreatments() {
  ...
  return (
    <section className="py-24 bg-canvas">
      <Container>
        <h2 className="text-[clamp(1.9rem,3.6vw,3rem)] font-bold leading-[1.05] tracking-[-0.035em] uppercase text-center mb-16 font-sans">Otros servicios corporales en DERMA.M</h2>
          ...
          {relatedTreatments.map((treatment) => (
            <Card key={treatment.id} className="group bg-white border border-border-card hover:border-base-900 hover:-translate-y-1 hover:shadow-md transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] shadow-subtle flex flex-col h-full overflow-hidden">
              ...
              <div className="p-8">
                ...
                <Link to={treatment.href} className="inline-flex items-center text-sm font-semibold text-text-primary group-hover:text-base-900 group/link">
