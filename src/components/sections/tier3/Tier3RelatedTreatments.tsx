...
export default function Tier3RelatedTreatments({ currentTreatmentId, relatedIds, allTreatments }: Tier3RelatedTreatmentsProps) {
 ...
 <div className="p-8">
 <span className="text-label-xs font-medium text-text-primary uppercase tracking-[0.15em] mb-3 block">
 {treatment.category}
 </span>
 <h3 className="text-xl font-sans text-text-primary mb-4 group-hover:text-text-primary transition-colors">
 {treatment.shortTitle}
 </h3>
 <div className="flex items-center gap-2 text-text-primary text-sm font-bold group-hover:gap-3 transition-all">
