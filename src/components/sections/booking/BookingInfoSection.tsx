        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {info.cards.map((card, idx) => (
              <div key={idx} className="flex gap-6 bg-white p-8 rounded-[2rem] border border-border-soft hover:-translate-y-1 hover:border-base-300 hover:shadow-subtle transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]">
