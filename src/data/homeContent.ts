export const homeContent = {
  ...
  founder: {
    ...
    bio: 'Con más de 10 años de experiencia en medicina estética, Nancy combina diagnóstico personalizado, protocolos seguros y criterio profesional para ayudarte a sentirte bien en tu piel.',
