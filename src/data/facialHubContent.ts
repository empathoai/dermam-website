...
export const facialHubContent: HubPageContent = {
  ...
  allGrid: {
    ...
    items: [
      ...
      { id: 'manchas-acne', title: 'Manchas y Cicatrices de Acné', category: 'Despigmentación', ctaLabel: 'Ver más →', href: '/es/reservar', image: { src: '/assets/images/skin-therapy.jpg', alt: 'Manchas y Cicatrices de Acné' } },
      { id: 'acne', title: 'Acné', category: 'Cuidado clínico', ctaLabel: 'Ver más →', href: '/es/reservar', image: { src: '/assets/images/facial-care.jpg', alt: 'Acné' } },
      { id: 'rejuvenecimiento', title: 'Rejuvenecimiento Facial / Lifting', category: 'Antiedad', ctaLabel: 'Ver más →', href: '/es/reservar', image: { src: '/assets/images/skincare-products.jpg', alt: 'Rejuvenecimiento Facial / Lifting' } },
