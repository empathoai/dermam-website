...
export const ivTherapyContent: IVTherapyPageContent = {
  hero: {
    ...
    image: {
      src: 'https://picsum.photos/seed/iv_hero/1920/1080',
  ...
  education: {
    ...
    image: {
      src: 'https://picsum.photos/seed/iv_process/1200/900',
  ...
  kitsSection: {
    ...
    subtitle: 'Cada kit está formulado para un objetivo específico. Nancy te orienta si no sabes cuál elegir.'
  },
  faqs: [
    {
    ...
    },
    {
      ...
      answer: 'Depende de tus objetivos. Algunos pacientes lo hacen semanalmente para apoyo inmunológico o energía, mientras que otros lo usan de forma ocasional para recuperación post-viaje o post-evento. Nancy evaluará tu caso.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Si te sientes deshidratado, el Quench es ideal. Si buscas claridad mental, Brainstorm es la opción. Nancy conversará contigo antes de iniciar para asegurar que el protocolo se alinee con lo que buscas.'
    },
    {
  ...
  finalCTA: {
    ...
    copy: 'Nancy te orienta y te ayuda a elegir el protocolo correcto para tu objetivo.',
    primaryCTA: {
    ...
    image: {
      src: 'https://picsum.photos/seed/iv_final_cta/1920/1080',
