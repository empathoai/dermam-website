...
export const ivKits: IVKit[] = [
  ...
  },
  {
    ...
    imagePrompt: 'Premium soothing wellness IV kit editorial image, elegant IV bag, soft lavender flowers, warm tea cup, folded ivory towel, pearl gray surface, calm PMS comfort mood, pastel lavender and sage accents, no clinical alarm feeling, no dark background, 4:3 ratio. Main subject must remain visible within the center 60% of the frame for mobile crop safety.',
    showPrice: false,
    price: 160,
    ctaLabel: 'Reservar →',
