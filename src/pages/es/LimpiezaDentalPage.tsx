...
export default function LimpiezaDentalPage() {
  const treatment = tier3Treatments.find(t => t.id === 'limpieza-dental');
...
export const ssgOptions = {
  slug: 'es/limpieza-dental/index',
  routeUrl: '/es/limpieza-dental',
  context: async (children: any) => {
    ...
    return React.createElement(
      HelmetProvider,
      null,
      React.createElement(MemoryRouter, { initialEntries: ['/es/limpieza-dental'] }, children)
    );
  }
};
