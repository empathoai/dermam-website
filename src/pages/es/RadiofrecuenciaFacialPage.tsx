...
export default function RadiofrecuenciaFacialPage() {
  const treatment = tier3Treatments.find(t => t.id === 'radiofrecuencia-facial');
...
export const ssgOptions = {
  slug: 'es/radiofrecuencia-facial/index',
  routeUrl: '/es/radiofrecuencia-facial',
  context: async (children: any) => {
    ...
    return React.createElement(
      HelmetProvider,
      null,
      React.createElement(MemoryRouter, { initialEntries: ['/es/radiofrecuencia-facial'] }, children)
    );
  }
};
