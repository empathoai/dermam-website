...
export default function CavitacionPage() {
  const treatment = tier3Treatments.find(t => t.id === 'cavitacion');
...
export const ssgOptions = {
  slug: 'es/cavitacion/index',
  routeUrl: '/es/cavitacion',
  context: async (children: any) => {
    ...
    return React.createElement(
      HelmetProvider,
      null,
      React.createElement(MemoryRouter, { initialEntries: ['/es/cavitacion'] }, children)
    );
  }
};
